...
<CardGroup cols={2}>
  ...
  <Card title="Advanced Sleep Summary" icon="moon-stars">
    Get full sleep API fields including stages, naps, physiological metrics, and pagination context.
  </Card>
...
### Querying advanced sleep data

```
User: "Show all sleep metrics for John last month, including naps and stages"
Claude: [calls get_users() to get John's user_id]
Claude: [calls get_sleep_summaries_advanced(user_id="uuid-1", start_date="2026-01-01", end_date="2026-01-31")]
Claude: "John averaged 7h 42m of main sleep, 90.6% efficiency, and took 6 naps totaling 2h 10m."
```
